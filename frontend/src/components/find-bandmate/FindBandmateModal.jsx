 ...
 *   options      FindBandmateOptionSets — injectable; defaults to mock data.
 */
  ...
  <Dialog.Root open={open} onOpenChange={onOpenChange}>
    <Dialog.Portal>
      ...
      <Dialog.Overlay
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 45%, rgba(59,130,246,0.08) 0%, rgba(0,0,0,0.74) 100%)",
      ...
      >
        ...
        <motion.div
          ...
          className="w-full md:w-[560px] flex flex-col overflow-hidden
            rounded-t-[1.5rem] max-h-[92dvh] landscape:max-h-[80dvh]
